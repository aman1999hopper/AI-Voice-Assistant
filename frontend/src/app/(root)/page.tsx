  ...
  const howItWorksSteps = [
    {
      ...
      description:
        "Just talk to your AI assistant like you would to a human. No commands to remember, no specific phrases needed.",
      icon: "🎤",
    },
    {
      step: "2",
      ...
      description:
        "Advanced NLP processes your speech instantly, understanding context, intent, and even emotions in your voice.",
      icon: "🧠",
    },
    {
      step: "3",
      ...
      description:
        "Our AI analyzes your request and accesses relevant information or performs the requested action seamlessly.",
      icon: "⚡",
    },
    {
      step: "4",
      ...
      description:
        "Get intelligent, contextual responses delivered in natural, human-like speech within milliseconds.",
      icon: "💬",
    },
  ];
  ...
  const slides = [
    {
      ...
      subtitle:
        "Experience the future of human-computer interaction with natural voice commands",
      cta: "Try Voice Demo",
    },
    {
      ...
      subtitle:
        "Control your digital world with the power of your voice. No keyboards required.",
      cta: "Start Speaking",
    },
    {
      ...
      subtitle:
        "Advanced natural language processing that gets smarter with every conversation.",
      cta: "Experience AI",
    },
  ];
                ...
                <div className="relative z-20 flex items-center justify-center h-full">
                  <div className="text-center max-w-5xl px-6">
                    <motion.h1
                      ...
                      key={slide.title} // ensures re-animation on slide change
                    >
                      {slide.title}
                    </motion.h1>
                    <motion.p
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                      <button className="px-8 py-4 bg-white text-gray-900 rounded-full font-semibold text-lg hover:bg-gray-100 transform hover:scale-105 transition-all duration-300 shadow-lg flex items-center justify-center space-x-2">
                        <span>🎤</span>
                        <span>{slide.cta}</span>
                      </button>
                    ...
                    <div className="mt-8 text-white/80 text-sm">
                      ...
                      {
                        12345 /* replace with activeUsers state if you have it */
                      }{" "}
                      users talking to AI right now
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Join millions who have revolutionized their digital experience
      ...
      <section className="py-20 px-6 bg-gray-900/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Advanced artificial intelligence that understands, processes, and
              responds to natural human speech
            </p>
          </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Cutting-edge technology that makes voice interaction feel natural
              and effortless
            </p>
          </div>
            ...
            {features.map((feature, idx) => (
              <div key={idx} className="group">
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-8 text-center border border-gray-700 hover:border-blue-500 transition-all duration-300 transform hover:scale-105 h-full">
                  <div
                    className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r ${feature.color} rounded-2xl text-2xl mb-6`}
                  >
                    {feature.icon}
                  </div>
                  <h3 className="text-xl font-bold text-white mb-4">
      ...
      <section className="py-20 px-6 bg-gray-900/30">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Real experiences from professionals who transformed their workflow
              with voice AI
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                Join the voice revolution and discover how AI can transform your
                daily interactions. No typing, no clicking – just natural
                conversation with intelligent technology.
              </p>
              ...
              <div className="bg-gradient-to-br from-blue-500/20 to-purple-600/20 rounded-3xl p-8 backdrop-blur-sm border border-gray-700">
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-300 mb-6">
                    Experience the power of voice AI with these examples
                  </p>
                </div>
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-800 rounded-xl p-4 border border-gray-600">
                    <div className="flex items-center space-x-3">
                      <span className="text-2xl">🎤</span>
                      <span>
                        &quot;Translate this to Spanish and send email&quot;
                      </span>
                    </div>
                  </div>
                  <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-4">
                    <div className="flex items-center space-x-3">
                      <span className="text-2xl">🤖</span>
                      <span>
                        &quot;I&apos;ve scheduled your meeting and sent the
                        email!&quot;
                      </span>
                    </div>
                  </div>
